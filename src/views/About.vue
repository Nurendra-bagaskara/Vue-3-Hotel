    ...
    <!-- NAVIGATION -->
        ...
        <div class="ex-basic-1 py-12">
            <div class="container px-4 sm:px-8">
                <img class="inline mt-12 mb-4" src="../../public/assets/images/article-details-large.jpg" alt="alternative" />
        ...
        <div class="ex-basic-1 pt-6 pb-12">
            <div class="container px-4 sm:px-8 xl:px-32">
                ...
                <img class="inline mb-12" src="../../public/assets/images/article-details-small.jpg" alt="alternative" />
